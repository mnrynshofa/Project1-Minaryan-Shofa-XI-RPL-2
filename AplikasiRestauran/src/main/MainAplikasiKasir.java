...
public class MainAplikasiKasir {
    ...
    public static void main(String[] args) { 
        ...
        //Tambahkan
        String no_transaksi, namaPemesan, tanggal, no_meja = "";
       ...
       //mulai transaksi
        ...
        //buat transaksi baru
        Transaksi trans = new Transaksi(no_transaksi, namaPemesan, tanggal, no_meja);
        ...
        //hitung total harga
         ...
         do {
            //ambil input uang bayar
             double uang_bayar = app.cekInputNumber("Uang Byar: \t\t");
